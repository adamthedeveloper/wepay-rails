...
Modify config/wepay.yml.example to your needs and copy it to wepay.yml. You will need to set the model and column where you are storing your wepay auth code:
...
Finally, your checkout controller (or some controller that will interact with the Wepay API) - notice it extends Wepay::ApplicationController:

    class Purchase::CheckoutController < Wepay::ApplicationController
...
wepay to checkout. Also, notice it extends Wepay::ApplicationController
